...
| 7 | **Catálogos** | **6 tipologías**, 20 zonas con su matriz de **86 relaciones**, **175 códigos CAPEX en árbol de 3 niveles** (6 categorías, 28 capítulos, 141 elementos), el árbol que mantiene el cliente `[REQ]` P-45, 4 grados de riesgo **con su definición íntegra**, 10 conceptos, 5 horizontes, 14 sistemas técnicos. Sembrados, versionados y ampliables por organización | Editor visual del árbol |
...
con definición, 10 conceptos, 5 horizontes, 14 sistemas, 8 fases, 73 nodos del árbol documental);
