...
| `npm run test:dashboard` | Los **cinco cortes** del dashboard cuadran entre sí en la pantalla, el filtro de **varios activos** alcanza a cuatro de ellos, «Qué edificio» sigue enseñando la cartera entera, y los tramos de una barra apilada suman su categoría | — |
